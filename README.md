...
[![Build](https://github.com/ComingCL/mcp-go/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/ComingCL/mcp-go/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/ComingCL/mcp-go?cache)](https://goreportcard.com/report/github.com/ComingCL/mcp-go)
[![GoDoc](https://pkg.go.dev/badge/github.com/ComingCL/mcp-go.svg)](https://pkg.go.dev/github.com/ComingCL/mcp-go)
...
```bash
go get github.com/ComingCL/mcp-go
```
